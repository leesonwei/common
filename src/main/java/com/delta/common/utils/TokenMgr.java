	...
	public static ServerResponse<Claims> validateJWT(String jwtStr) {
		...
		try {
			...
			serverResponse = ServerResponse
					.createByErrorCodeMessage(JWTCode.JWT_ERRCODE_EXPIRE.getCode(),JWTCode.JWT_ERRCODE_EXPIRE.getDesc());
		} catch (SignatureException e) {
			serverResponse = ServerResponse
					.createByErrorCodeMessage(JWTCode.JWT_ERRCODE_FAIL.getCode(),JWTCode.JWT_ERRCODE_FAIL.getDesc());
		} catch (Exception e) {
			serverResponse = ServerResponse
					.createByErrorCodeMessage(JWTCode.JWT_ERRCODE_FAIL.getCode(),JWTCode.JWT_ERRCODE_FAIL.getDesc());
		}
