...
public class DateUtil {
    ...
    public static String getDateVersion() {
        return getCurrentTime(GlobalConst.DATE_VERSION);
    }
    ...
    public static String getCurrentDate() {
        String datestr = null;
        SimpleDateFormat df = new SimpleDateFormat(GlobalConst.DATE_FORMAT);
        datestr = df.format(new Date());
        return datestr;
    }
    ...
    public static String getCurrentDateTime() {
        String datestr = null;
        SimpleDateFormat df = new SimpleDateFormat(GlobalConst.DATE_TIME_FORMAT);
        datestr = df.format(new Date());
        return datestr;
    }
